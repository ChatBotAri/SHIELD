    ...
    <Container>
      <Header>
        ...
        <ProgressBarAnimated
          ...
          value={DinnerNut.kcal>myNut*0.25?100:DinnerNut.kcal/(myNut*0.25/100)}
          maxValue={500}
          height={20}
      ...
      <NutContainer>
        <NutBox>
          ...
          <NutText>{DinnerNut.carbs} g</NutText>
        </NutBox>
        <NutBox>
          <NutText>단백질</NutText>
          <NutText>{DinnerNut.protein} g</NutText>
        </NutBox>
        <NutBox>
          <NutText>지방</NutText>
          <NutText>{DinnerNut.fat} g</NutText>
        </NutBox>
      </NutContainer>
      <Body>
        <TitleBox>
